    ...
    <div className="flex-1 overflow-y-auto bg-sidebar">
      <div className="p-4 border-b border-sidebar-border">
        <div className="flex items-center gap-2">
          <ListBullets className="h-4 w-4 text-sidebar-foreground/60" weight="duotone" />
      ...
      <div className="p-4 space-y-3">
        {Object.keys(groupedAppointments).length === 0 ? (
          <div className="text-center py-6">
            <CalendarBlank className="h-6 w-6 text-sidebar-foreground/40 mx-auto mb-2" weight="duotone" />
