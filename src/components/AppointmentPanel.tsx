...
import { createCallInvitation } from '../services/callService';
...
export function AppointmentPanel({
  ...
  const [formData, setFormData] = useState({
    ...
    duration: '60',
    type: appointment.type as 'appointment' | 'break' | 'tentative',
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="tentative" className="cursor-pointer">Tentative</Label>
                    </div>
                  </RadioGroup>
                </div>
