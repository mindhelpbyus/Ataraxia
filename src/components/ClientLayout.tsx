                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-action to-orange-600 flex items-center justify-center shadow-lg shadow-action/30">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <CardContent>
                            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 sm:gap-4">
                                {[
                                    ...
                                    { mood: 'Okay', icon: <Meh className="w-7 h-7 sm:w-8 h-8" />, color: 'from-yellow-400 to-action' },
                                    { mood: 'Low', icon: <Cloud className="w-7 h-7 sm:w-8 h-8" />, color: 'from-action to-red-400' },
                            ...
                            {selectedMood && (
                                ...
                                >
                                    <p className="text-sm text-action-dark font-medium">
                ...
                <div className="grid lg:grid-cols-3 gap-6 sm:gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6 sm:space-y-8">
                        ...
                        >
                            <Card className="border-0 bg-gradient-to-br from-action to-orange-600 text-white shadow-2xl shadow-action/30 overflow-hidden">
                                    ...
                                    <div className="flex flex-col sm:flex-row items-start justify-between gap-6">
                                        <div className="space-y-4 flex-1">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-action-light text-base sm:text-lg font-medium">{upcomingSession.date} at {upcomingSession.time}</p>
                                            </div>
                        ...
                        >
                            <Card className="shadow-lg shadow-gray-200/50 border-gray-200">
                                ...
                                <CardContent className="space-y-3">
                                    ...
                                    <Button
                                        className="w-full bg-gradient-to-r from-action to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white shadow-lg font-semibold mt-4"
                                        size="lg"
                                    >
                        ...
                        >
                            <Card className="shadow-lg shadow-gray-200/50 border-gray-200">
                                ...
                                <CardContent className="space-y-3">
                                    <Button
                                        variant="outline"
                                        className="w-full justify-start h-auto py-4 border-2 hover:border-action-border hover:bg-action-light transition-all"
                                    >
                                        <Calendar className="w-5 h-5 mr-3 text-action flex-shrink-0" />
                                        <div className="text-left">
                                    ...
                                    <Button
                                        ...
                                        className="w-full justify-start h-auto py-4 border-2 hover:border-action-border hover:bg-action-light transition-all"
                                    >
                                        <MessageSquare className="w-5 h-5 mr-3 text-action flex-shrink-0" />
                                        <div className="text-left">
                                    ...
                                    <Button
                                        ...
                                        className="w-full justify-start h-auto py-4 border-2 hover:border-action-border hover:bg-action-light transition-all"
                                    >
                                        <Heart className="w-5 h-5 mr-3 text-action flex-shrink-0" />
                                        <div className="text-left">
